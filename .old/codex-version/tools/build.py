...
PERSON_LD = """<script type="application/ld+json">
{
  ...
  "image": "https://angheldiana.ro/assets/dr-anghel-andreea-diana-portrait.jpg",
...
def build_index():
    ...
    cities = "\n".join(
        """      <a class="city-card" href="unde-ma-gasiti.html#%s">
        <span class="city-number">0%s</span>
        <h3>%s</h3>
        <p>%s</p>
        <span class="city-arrow" aria-hidden="true">↗</span>
      </a>""" % (slug(city), index, city, " · ".join(c["name"] for c in clinics))
  ...
  <div class="wrap">
    <div>
      <p class="hero-kicker">Dermatologie · București · Ploiești / Păuleștii Noi · Buzău</p>
      <h1><span>Dr. Anghel</span><span class="accent">Andreea-Diana</span></h1>
      <p class="role">%s</p>
    ...
    <figure class="portrait">
      <img src="assets/dr-anghel-andreea-diana-portrait.jpg" width="1024" height="1536"
...
<section class="fact-bar" aria-label="Pe scurt">
  <div class="wrap">
    <p><span>01</span><strong>Medic specialist</strong><small>Dermatovenerologie</small></p>
    <p><span>02</span><strong>Formare internațională</strong><small>România · Germania · Franța</small></p>
    <p><span>03</span><strong>Consultații în cabinet</strong><small>București · zona Ploiești · Buzău</small></p>
  </div>
</section>

<section class="band band--stone home-services">
  <div class="wrap">
    <div class="band-head">
...
""" % (ROLE, items, vision, cities, faq_links)
